...
const ReviewCard = ({ review, className = "", style }: ReviewCardProps) => (
  <div
    className={`relative group bg-card rounded-2xl p-6 border border-border/50 hover:border-primary/30 shadow-soft hover:shadow-card transition-all duration-300 overflow-hidden ${className}`}
    style={style}
  >
